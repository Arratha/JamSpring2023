    ...
    public class BugQuest_Controller : MonoBehaviour
    {
        ...
        private string[][] _messages = new string[][]
        {
            new string[]
            {
                ...
                "Да-да, катающаяся желейка, именно ты!",
                "Выполни мою просьбу, облей меня водой, и за это, я дам тебе нечто очень ценное…"
            } ,
            new string[]
            {
                ...
                "Ну, возьми тогда этот листик, больше мне все равно нечего тебе дать, может пригодится."
            }
        };
