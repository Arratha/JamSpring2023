Shader "Sprites/Water Distortion"
{
	Properties
	{
		...
		[NoScaleOffset] _MainTex("Distortion Texture", 2D) = "white" {}
		...
		SubShader
		{
			...
			Pass
			{
				...
				fixed4 frag(v2f IN) : SV_Target
				{
					...
					fixed4 c = tex2D(_GrabTexture, IN.grabcoord + (refraction * tex2D(_MainTex, distortionScale * IN.texcoord))) * IN.color;
					c.rgb *= c.a;
